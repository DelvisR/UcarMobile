    ...
    public partial class InitialMigration : Migration
    {
        ...
        private static void AddSeedData(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Role",
                columns: ["Id", "Name", "Description", "CreatedBy", "CreatedDate", "LastModifiedBy", "LastModifiedDate", "IsDeleted"],
                values: new object[,]
                {
            {
                1, "SuperAdmin",
            ...
            migrationBuilder.InsertData(
                ...
                columns:
                [
                    "Name", "Description", "Resource", "CreatedBy", "CreatedDate", "LastModifiedBy", "LastModifiedDate", "IsDeleted"
                ],
                values: new object[,]
                {
                    {
                        "ACTION_CREATE_USER", "Allows creating new users", "RESOURCE_DEFAULT", "System", DateTime.UtcNow,
                        "System", DateTime.UtcNow, false
                    },
                    {
                        "ACTION_EDIT_USER", "Allows editing existing users", "RESOURCE_DEFAULT", "System", DateTime.UtcNow,
                        "System", DateTime.UtcNow, false
                    },
                    {
                        "ACTION_CREATE_CLIENT", "Allows creating new clients", "RESOURCE_DEFAULT", "System", DateTime.UtcNow,
                        "System", DateTime.UtcNow, false
                    },
                    {
                        "ACTION_EDIT_CLIENT", "Allows editing existing clients", "RESOURCE_DEFAULT", "System", DateTime.UtcNow,
                        "System", DateTime.UtcNow, false
                    },
                    {
                        "ACTION_CREATE_ROLE", "Allows creating new roles", "RESOURCE_DEFAULT", "System", DateTime.UtcNow,
                        "System", DateTime.UtcNow, false
                    },
                    {
                        "ACTION_EDIT_ROLE", "Allows editing existing roles", "RESOURCE_DEFAULT", "System", DateTime.UtcNow,
                        "System", DateTime.UtcNow, false
                    },
                    {
                        "ACTION_DELETE_ROLE", "Allows deleting roles", "RESOURCE_DEFAULT", "System", DateTime.UtcNow, "System",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    {
                        "ACTION_VIEW_MAIN_MENU_BUSINESS_PARAMETER", "Bussiness parameters menu action", "RESOURCE_MAIN_MENU", "System",
                        DateTime.UtcNow, "System", DateTime.UtcNow, false
                    },
                });
